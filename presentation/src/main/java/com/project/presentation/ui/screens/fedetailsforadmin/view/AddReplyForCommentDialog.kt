        ...
        Surface(
            ...
            Box(
                ...
                Column(modifier = Modifier.padding(20.dp)) {
                    ...
                    Text(
                        text = stringResource(id = R.string.add_your_reply),
                    ...
                    Row(
                        ...
                        Button(
                            ...
                            enabled = replyText?.isNotEmpty() == true
                        ) {
                            Text(
...
@Composable
fun AddReplyForCommentDialogPreview() {
    AddReplyForCommentDialog(onDismissDialog = {}, onReplyClicked = {})
}
